      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category1599"> <a href="#" title="">Search Results</a> <span>&rsaquo; </span> </li>
          </ul>
        </div>
        <!--col-xs-12--> 
      </div>
      ...
      <div class="pro-coloumn">
        <article class="col-main">
          ...
          <div class="category-products">
            ...
            <?php
            if($make != "" && $model != "" && $year != "" && $color != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and model = '$model' and year = '$year' and color = '$color' and countrystock = '$country'";
            }
            else if($make != "" && $model != "" && $year != "" && $color != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and model = '$model' and year = '$year' and color = '$color'";
            }
            else if($make != "" && $model != "" && $year != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and model = '$model' and year = '$year' and countrystock = '$country'";
            }
            else if($make != "" && $model != "" && $color != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and model = '$model' and countrystock = '$country' and color = '$color'";
            }
            else if($make != "" && $year != "" && $color != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and countrystock = '$country' and year = '$year' and color = '$color'";
            }
            else if($model != "" && $year != "" && $color != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and countrystock = '$country' and model = '$model' and year = '$year' and color = '$color'";
            }
            else if($make != "" && $model != "" && $year != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and model = '$model' and year = '$year'";
            }
            else if($make != "" && $model != "" && $color != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and model = '$model' and color = '$color'";
            }
            else if($make != "" && $model != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and model = '$model' and countrystock = '$country'";
            }
            else if($year != "" && $color != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and year = '$year' and color = '$color' and countrystock = '$country'";
            }
            else if($year != "" && $color != "" && $make != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and color = '$color' and year = '$year'";
            }
            else if($year != "" && $color != "" && $model != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and color = '$color' and model = '$model' and year = '$year'";
            }
            else if($color != "" && $country != "" && $make != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and color = '$color' and countrystock = '$country'";
            }
            else if($color != "" && $country != "" && $model != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and color = '$color' and model = '$model' and countrystock = '$country'";
            }
            else if($model != "" && $year != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and countrystock = '$country' and model = '$model' and year = '$year'";
            }
            else if($make != "" && $country != "" && $year != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and countrystock = '$country' and year = '$year'";
            }
            else if($make != "" && $model != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and model = '$model'";
            }
            else if($make != "" && $year != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and year = '$year'";
            }
            else if($make != "" && $color != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and color = '$color'";
            }
            else if($make != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make' and countrystock = '$country'";
            }
            else if($year != "" && $model != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and year = '$year' and model = '$model'";
            }
            else if($color != "" && $model != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and color = '$color' and model = '$model'";
            }
            else if($country != "" && $model != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and countrystock = '$country' and model = '$model'";
            }
            else if($year != "" && $color != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and year = '$year' and color = '$color'";
            }
            else if($year != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and year = '$year' and countrystock = '$country'";
            }
            else if($color != "" && $country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and color = '$color' and countrystock = '$country'";
            }
            else if($make != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and make = '$make'";
            }
            else if($model != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and model = '$model'";
            }
            else if($year != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and year = '$year'";
            }
            else if($color != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and color = '$color'";
            }
            else if($country != "")
            {
                $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and countrystock = '$country'";
            }
            else
            {

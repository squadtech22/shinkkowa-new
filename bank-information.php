...
<p>Shinkyowa Japan aims to provide the most feasible payment options to its customers all across the globe for smooth business transactions. Our objective has always been to facilitate customers with the simplest payment methods. They can conveniently transfer funds to our bank account through the bank details offered at their aid.</p>
<table>
    <tr>
        <td style="font-weight: bold; color: #50B2FC;">Bank Name</td>
        <td>SUMITOMO MITSUI BANKING CORPORATION</td>
    </tr>
    <tr>
        <td style="font-weight: bold; color: #50B2FC;">Branch</td>
        <td>TOYAMA BRANCH</td>
    </tr>
    <tr>
        <td style="font-weight: bold; color: #50B2FC;">Address</td>
        <td>CHUODORI TOYAMA SHI JAPAN</td>
    </tr>
    <tr>
        <td style="font-weight: bold; color: #50B2FC;">Swift Code</td>
        <td>S M B C J P J T</td>
    </tr>
    <tr>
        <td style="font-weight: bold; color: #50B2FC;">Account No</td>
        <td>ORDANARY A/C NO. 1027847</td>
    </tr>
    <tr>
        <td style="font-weight: bold; color: #50B2FC;">Account Holder</td>
        <td>SHIN KYOWA INTERNATIONAL Co. LTD</td>
    </tr>
</table>
</div>
</div></div> 

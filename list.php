      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category1599"> <a href="#" title=""><?php echo $stockType; ?></a> <span>&rsaquo; </span> </li>
          </ul>
        </div>
        <!--col-xs-12--> 
      </div>
    ...
    <div class="row">
      ...
      <div class="pro-coloumn">
        <article class="col-main">
          <div class="toolbar">
            <div class="sorter">
              <div class="view-mode"><a href="grid.php?id=<?php echo $stockType; ?>" title="List" class="button-grid">&nbsp;</a> <span title="list" class="button button-active button-list">&nbsp;</span> </div>
            </div>
        ...
        <?php
            $sql = "SELECT * from vehicle as v join vehicle_details as s where v.id = s.vehicleid and INSTR(stocktype, '$stockType') > 0";

...
<div class="page-heading" style="background-image: url(countries/<?php echo $country; ?>.jpg); opacity: 1; background-repeat: no-repeat; background-size: 100% 100%;">
    ...
    <div class="row">
      ...
      <div class="pro-coloumn">
        <article class="col-main">
          <div class="toolbar">
            <div class="sorter">
              <div class="view-mode"><a href="country.php?id=<?php echo $country; ?>" title="List" class="button-grid">&nbsp;</a> <span title="list" class="button button-active button-list">&nbsp;</span> </div>
            </div>
          ...
          <div style="border-left: 5px solid #50B2FC; margin-left: 15px;">
              <h2 style="margin-left: 5px; text-transform: uppercase; font-size: 25px;">
              <?php
                  if($country == "Japan") {
                      echo "Our Stock In";
                  } else {
                      echo "Best Selling Cars In";
                  }
              ?> 
              <span style="color: #50B2FC; font-weight: bold;"><?php echo $country; ?></span>
              <?php 
                if($country == "Japan") {
                    echo "Showroom";
                }
          ...
          <li class="item first">
            ...
            <div class="product-shop">
              ...
              <div class="price-box">
                ...
                <p class="special-price"> <span class="price-label"></span> <span id="product-price-212" class="price"> <?php echo $row['pricefob']; ?> </span> </p>
              </div>
              <div class="actions">

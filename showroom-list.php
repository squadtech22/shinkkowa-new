...
<title>Shinkyowa Showroom</title>
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category1599"> <a href="#" title="">Showroom</a> <span>&rsaquo; </span> </li>
          </ul>
        </div>
        <!--col-xs-12--> 
      </div>
    ...
    <div class="row">
      ...
      <div class="pro-coloumn">
        <article class="col-main">
          <div class="toolbar">
            <div class="sorter">
              <div class="view-mode"><a href="showroom.php" title="List" class="button-grid">&nbsp;</a> <span title="list" class="button button-active button-list">&nbsp;</span> </div>
            </div>

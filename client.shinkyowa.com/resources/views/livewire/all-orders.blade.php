                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a onclick="return confirm('Are you sure you want to delete this order?')" href="/delete-order/{{ $order->id }}" class="btn btn-warning"><i class="far fa-trash-alt"></i> Delete</a>
                                </div>
                            </td>
                        </tr>
                        @endforeach

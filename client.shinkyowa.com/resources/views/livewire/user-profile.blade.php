    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                ...
                @if ($showSuccesNotificationPassword)
                    <div wire:model="showSuccesNotificationPassword"
                        class="mt-3 alert alert-primary alert-dismissible fade show" role="alert">
                        <span class="alert-icon text-white"><i class="ni ni-like-2"></i></span>
                        <span
                            class="alert-text text-white">{{ __('Your profile information have been successfuly saved!') }}</span>
                        <button wire:click="$set('showSuccesNotificationPassword', false)" type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        </button>
                    </div>
                @endif
                ...
                <form wire:submit.prevent="changePassword" action="#" method="POST" role="form text-left">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user-new-password" class="form-control-label">{{ __('New Password') }}</label>
                                <div class="@error('new_password') border border-danger rounded-3 @enderror">
                                    <input wire:model="new_password" class="form-control" type="text"
                                        placeholder="New Password" id="user-new-password">
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user-confirm-password" class="form-control-label">{{ __('Confirm Password') }}</label>
                                <div class="@error('confirm_password') border border-danger rounded-3 @enderror">
                                    <input wire:model="confirm_password" class="form-control" type="text"

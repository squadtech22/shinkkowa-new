    ...
    <div class="row">
      ...
      <div class="pro-coloumn">
        <article class="col-main">
          <div class="toolbar">
            <div class="sorter">
              <div class="view-mode"> <span title="Grid" class="button button-active button-grid">&nbsp;</span><a href="list.php?id=<?php echo $stockType; ?>" title="List" class="button-list">&nbsp;</a> </div>
            </div>
